...
/* Copyright (C) 1986 Gary S. Brown.  You may use this code or tables
...
CRC32 crc32tab[] = { /* a table of 32-bit CRC feedback terms */
...
{
  while (len--)
    a = crc32tab[(unsigned char)a^(unsigned char)*s++] ^ (a >> 8);
  return a;
}
